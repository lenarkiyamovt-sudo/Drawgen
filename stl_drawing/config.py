...
#: Длина стрелки размерной линии (мм)
DIM_ARROW_LENGTH: float = 2.5

#: Ширина стрелки размерной линии (мм)
DIM_ARROW_WIDTH: float = 0.8

#: Высота шрифта размерных надписей (мм), ГОСТ 2.304-81 тип Б
